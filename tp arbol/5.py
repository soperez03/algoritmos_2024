...
c = tree.inorden_superheros_start_with('C')


contador= tree.contar_super_heroes()
print(f'la cantidad de super heroes es:{contador}')
...
a_superh= BinaryTree()
a_villanos= BinaryTree()
for personaje in super_heroes:
  is_hero = False if 'villano' in personaje else True
  personaje['is_hero']= is_hero
  if is_hero:
        a_superh.insert_node(personaje['nombre'], personaje)
  else:
        a_villanos.insert_node(personaje['nombre'], personaje)
print('el arbol de super heroes es: ')
a_superh.inorden()
print()
nodos_superheroes = a_superh.contar_super_heroes
print('y la cantidad de nodos es: ', nodos_superheroes)


print()
print('el arbol vilanos es: ')
a_villanos.inorden_villanos()
nodos_villanos= a_villanos.contar_villanos()
print('y la cantidad de nodos es: ', nodos_villanos)

'''el recorrido inorden ya lo devuelve en orden alfabetico'''
